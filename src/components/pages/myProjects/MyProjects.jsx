		...
		<>
			...
			<section id="myProjects" className="section_myProjects">
				<article className="card_project">
					<h2>Ecommerce - Audiophile</h2>
					<img src={audio_mockups} alt="" className="img_project" />
				...
				<article className="card_project">
					<h2>Halloween - Shop </h2>
					<img src={hallowen_mockups} alt="" className="img_project" />
					<div className="container_tecn_project">
						<span>FrontEnd</span>
						<span>Javascript</span>
						<span>Swiper</span>
						<span>AnimateOnScroll</span>
						<span>Css</span>
					</div>
					<div className="container_descript_icons">
						<p className="text_description_project">
				...
				<article className="card_project">
					<h2> Tarot - Oráculo Mágico </h2>
					<img src={tarot_mockups} alt="" className="img_project" />
					<div className="container_tecn_project">
						<span>FrontEnd</span>
						<span>Javascript</span>
						<span>Css</span>
